...
def search(domain, limit):
    all_emails = []
    app_retrieveemail.show_message("[+] Searching in Youtube")
    ...
    app_retrieveemail.init_search(yahooUrl, domain, limit, 1, 100, 'Yahoo + Youtube')
